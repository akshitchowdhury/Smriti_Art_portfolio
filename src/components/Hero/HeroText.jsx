...
const HeroText = () => {
  return (
    <div className="container absolute -my-[1%] lg:-my-[0%] md:-my-[0%] md:labsolute md:top-0
     lg:absolute lg:right-72 lg:top-[200px] md:-left-[310px] left-[10px] top-[480px]">
  ...
  <span className="text-blue-200 ">Gogoi's</span> <span className='text-2xl'>Art Page</span>
</h1>
